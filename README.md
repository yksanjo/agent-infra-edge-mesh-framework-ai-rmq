# agent-infra-edge-mesh-framework-ai-rmq

## Detailed Description

agent-infra-edge-mesh-framework-ai-rmq is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
